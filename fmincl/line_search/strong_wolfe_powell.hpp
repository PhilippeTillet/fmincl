  ...
  struct strong_wolfe_powell : public line_search{
      ...
      class implementation : public line_search::implementation<BackendType>{
        ...
        public:
          ...
          void operator()(line_search_result<BackendType> & res, fmincl::direction::implementation<BackendType> * direction, detail::optimization_context<BackendType> & c, ScalarType ai) {
            c1_ = 1e-4;
